...
"""
openedx_app documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'openedx_app',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/dires318/openedx_app",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'This is test for openedex',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_app'),
                os.path.join(root_path, 'openedx_app/migrations')])
