#!/usr/bin/env python
"""
Package metadata for openedx_app.
"""
import os
import re
import sys
...
VERSION = get_version('openedx_app', '__init__.py')
...
setup(
    name='openedx_app',
    version=VERSION,
    description="""This is test for openedex""",
    long_description=README + '\n\n' + CHANGELOG,
    author='Dires Aman',
    author_email='getdera6591@gmail.com',
    url='https://github.com/dires318/openedx_app',
    packages=find_packages(
        include=['openedx_app', 'openedx_app.*'],
        exclude=["*tests"],
    ),
